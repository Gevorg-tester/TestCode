...
describe('ToDexpo', ()=> {
    it('Register', ()=> {
        ...
        cy.get('button[id="header_signin"]').click();
        cy.get('.text > .reg_form_link').click();
        cy.get(':nth-child(4) > .ui-textbox > .ui-textbox__content > .ui-textbox__label > .ui-textbox__input').type('cvnghdkcd54554sdfddf5@.ru');
        ...
        cy.get('.button_row > .btn').click()
        // cy.contains('Invalid email.').should('be.visible') after click
