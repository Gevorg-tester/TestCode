describe('Save_Continue', () => {
    it('Save_Continue', () => {
        ...
        cy.get(':nth-child(8) > .ui-textbox > .ui-textbox__content > .ui-textbox__label > .ui-textbox__input')
          ...
          .click();
          cy.get(':nth-child(7) > .form_input_hr > .ui-select > .ui-select__content > .ui-select__label > .ui-select__display').click();
          cy.get('.ui-select-option ui-select-option--type-basic').click();
